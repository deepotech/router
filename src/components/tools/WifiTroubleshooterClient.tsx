...
export interface WifiTroubleshooterClientProps {
  issueType: IssueType;
}

// Dynamically import the heavy troubleshooter client with a stable h-[450px] skeleton to avoid CLS
const WifiTroubleshooterImpl = dynamic(
  () => import("./WifiTroubleshooterImpl"),
  {
    ssr: false,
    loading: () => (
...
export default function WifiTroubleshooterClient(props: WifiTroubleshooterClientProps) {
  return <WifiTroubleshooterImpl {...props} />;
}
